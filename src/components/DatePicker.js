...
export default function DatePicker({endDate, selectDate, getSelectedDay, color, labelFormat}) {
    ...
    const selectedStyle = {fontWeight:"bold",width:"48px",height:"48px",borderRadius:"5px",zIndex: 0, background: primaryColor ,border:`2px solid ${primaryColor}`,color:"#f3f3f3"};
